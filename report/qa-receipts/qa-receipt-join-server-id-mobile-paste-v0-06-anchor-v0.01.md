# QA receipt — Join-server-id-mobile-paste-v0.06-anchor v0.01

- Original task: join-server-id-mobile-paste-v0.06-anchor
- Task identity: Join-server-id-mobile-paste-v0.06-anchor v0.01
...
- report/qa-receipts/qa-receipt-join-server-id-mobile-paste-v0-06-anchor-v0.01.md
- src/Client/App/corp-tower/Cor/Scripts/JoinScreen.gd
- src/Client/App/corp-tower/Tests/Gut/test_private_lobby.gd
...
- Protected contract: Server ID touch context-menu anchoring uses the field-local gui_input coordinate transform while paste completion preserves the field value and exits edit mode without navigation.
