...
export const ROUTE_RULES = [
  ...
  { pattern: /^scripts\/task-report-stop\.mjs$/, skill: 'docs-steward', docs: ['automation.md'], map: 'infra.md', read: 'hunk' },
  { pattern: /^scripts\/lib\/task-report-.*\.mjs$/, skill: 'docs-steward', docs: ['automation.md'], map: 'infra.md', read: 'hunk' },
  { pattern: /^report\/(?:v2\/reports\/)?task-token-cost-effectivity\.md$/, skill: 'docs-steward', docs: ['automation.md'], map: null, read: 'hunk' },
  { pattern: /^report\/v3\/reports\/index\.md$/, skill: 'docs-steward', docs: ['automation.md'], map: null, read: 'hunk' },
