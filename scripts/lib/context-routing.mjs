...
export const ROUTE_RULES = [
  ...
  { pattern: /^scripts\/benchmark-rag\.mjs$/, skill: 'docs-steward', docs: ['automation.md', 'testing.md'], map: 'infra.md', read: 'hunk', doc_anchors: ['report/benchmarks/', 'context-retrieval.json'] },
  ...
  { pattern: /^scripts\/(?:build-concept-map|validate-concept-kb|export-kb-calibration-report)\.mjs$/, skill: 'docs-steward', docs: ['automation.md', 'testing.md'], map: 'infra.md', read: 'hunk' },
  { pattern: /^scripts\/(?:lib\/(?:concept-kb|kb-calibration)\.mjs|fixtures\/concept-retrieval\.json|tests\/(?:concept-kb|kb-calibration)\.test\.mjs)$/, skill: 'docs-steward', docs: ['automation.md', 'testing.md'], map: 'infra.md', read: 'hunk' },
  ...
  { pattern: /^\.codex\/hooks\.json$/, skill: 'docs-steward', docs: ['automation.md'], map: null, read: 'full' },
