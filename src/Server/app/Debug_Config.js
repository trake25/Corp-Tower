...
const FIELD_PATHS = {
    ...
    towerLateralLoadShare: ["game", "towerLateralLoadShare"],
...
const RULES = {
    ...
    towerLateralLoadShare: ["number", 0, 1],
    ...
    strongReinforcementActionShare: ["number", 0.1, 2],
    criticalSaveActionShare: ["number", 0.1, 5],
    perfectBuildFinisherActionShare: ["number", 0.1, 8],
    perfectBuildImpactRequirementShare: ["number", 0, 0.5],
