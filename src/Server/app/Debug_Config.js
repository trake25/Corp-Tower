...
const FIELD_PATHS = {
    ...
    towerMaxTiltAngleDeg: ["game", "towerMaxTiltAngleDeg"],
    ...
    placementStabilityFloor: ["scoring", "placementStabilityFloor"],
    reinforceScorePerIntegrity: ["scoring", "reinforceScorePerIntegrity"],
    reinforceScorePerLean: ["scoring", "reinforceScorePerLean"],
    finisherBonusPerLevel: ["scoring", "finisherBonusPerLevel"],
    precisionBonusPerLevel: ["scoring", "precisionBonusPerLevel"],
    teamExactBonusPerLevel: ["scoring", "teamExactBonusPerLevel"],
    assistBonusPerLevel: ["scoring", "assistBonusPerLevel"],
    assistContributionThreshold: ["scoring", "assistContributionThreshold"],
...
const RULES = {
    ...
    placementStabilityFloor: ["number", 0, 1],
    reinforceScorePerIntegrity: ["number", 0, 25],
    reinforceScorePerLean: ["number", 0, 200],
    finisherBonusPerLevel: ["int", 0, 25],
    precisionBonusPerLevel: ["int", 0, 25],
    teamExactBonusPerLevel: ["int", 0, 25],
    assistBonusPerLevel: ["int", 0, 25],
    assistContributionThreshold: ["number", 0, 1],
