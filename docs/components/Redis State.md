...
- Room snapshots preserve serializable gameplay state such as shape inventory, `currentHeight`, `checkpointScores`, `drawPile`, `teamCarryOverBlocks`, and `towerBlocks`.
