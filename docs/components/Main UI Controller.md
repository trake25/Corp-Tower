...
- Placement popups use player color and `placementScorePopupDurationMs`; MVP, Perfect Fit, team total, checkpoint, and bonus-style popups use `finishScorePopupDurationMs`.
