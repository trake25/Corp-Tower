...
- Room snapshots preserve serializable gameplay state (shape inventory, `currentHeight`, `impactScores`, `impactPowers`, `drawPile`, `drawPileStartCount`, `teamCarryOverBlocks`, `towerBlocks`, quick-chat cooldown timestamps) while excluding transient chat events.
