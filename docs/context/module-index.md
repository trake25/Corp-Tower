...
| Block Preview | `Cor/Scripts/BlockPreview.gd` | Draws rotated block previews + placeholder hollow corner snap-point dots (drag ghost only) | none | [ui.md](./ui.md#leaf-components) |
| Tower Stack | `Cor/Scripts/TowerStack.gd` | Draws placed-block tower (fixed brick size, scroll/clip capped at target height), filled corner snap-point overlay, spawn-height-driven drop animation, tilt animation | Player Colors | [ui.md](./ui.md#leaf-components) |
