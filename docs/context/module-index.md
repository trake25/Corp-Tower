...
| Snap Grid | `Cor/Scripts/GameUi/SnapGrid.gd` | Node-free placement math: snap-point sets, 2-D vertex↔point resolution, gravity settle mirroring the server, placeable-origin range | Block Data | [ui.md](./ui.md#main-ui-controller) |
