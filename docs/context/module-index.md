...
| Block Preview | `Cor/Scripts/BlockPreview.gd` | Draws rotated block previews + placeholder anchor-cell marker | none | [ui.md](./ui.md#leaf-components) |
| Tower Stack | `Cor/Scripts/TowerStack.gd` | Draws placed-block tower (fixed brick size, scroll/clip capped at target height), lane guides, drop animation, tilt animation | Player Colors | [ui.md](./ui.md#leaf-components) |
