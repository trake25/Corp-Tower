...
| Tower Stack | `Cor/Scripts/TowerStack.gd` | Draws placed-block tower (fixed brick size, unlimited scroll/clip), lane guides, drop animation, tilt animation | Player Colors | [ui.md](./ui.md#leaf-components) |
