...
- Client runtime: [[Godot Client App]], [[NetworkManager]], [[Screen Manager]], [[Main UI Controller]] (now a slim orchestrator over the `Cor/Scripts/GameUi/` module family — see its doc), [[Game UI Scene]], [[Block Preview]], [[Tower Stack]], [[Popover Panel]], [[Impact Bar]], [[Cooldown Overlay]], [[Debug Overlay]], [[Player Colors]]
